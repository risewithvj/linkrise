...
(function (global) {
    ...
    function render(state) {
      ...
      if (state.result) {
        ...
        var copyBtn = h('button', {
          class: 'lr-btn-primary', onclick: function () {
      ...
      var pwToggle = h('button', {
        type: 'button', class: 'lr-pw-tog', onclick: function () {
      ...
      root.appendChild(h('div', { class: 'lr-card' }, [
        h('h2', { class: 'lr-card-h2' }, 'Shortlink  Generator'),
      ...
      if (state.results) {
        ...
        root.appendChild(h('div', { class: 'lr-card lr-card-success' }, [
          ...
          h('div', { class: 'lr-result-btns' }, [
            ...
            h('a', {
              class: 'lr-btn-secondary', href: '#', onclick: function (e) {
                e.preventDefault();
                var csv = 'Short URL,Original URL\n' + state.results.results.map(function (r) { return '"' + r.short + '","' + r.orig + '"'; }).join('\n');
                var blob = new Blob([csv], { type: 'text/csv;charset=utf-8;' });
                var url = URL.createObjectURL(blob);
                var a = document.createElement('a'); a.href = url; a.download = 'linkrise-bulk.csv'; a.style.display = 'none';
  ...
  function LR_Landing(root, cfg) {
    ...
    function render(phase, state) {
      ...
      if (phase === 'password') {
        ...
        var unlockBtn = h('button', {
          class: 'lr-btn-primary lr-btn-full', onclick: function () {
            var pwd = pwInp.value;
            if (!pwd) return;
    ...
    function reportBtn() {
      ...
      var wrap = h('div', {});
      var link = h('button', {
        class: 'lr-report-link', onclick: function () {
          shown = !shown;
      ...
      function showForm() {
        var sel = h('select', { class: 'lr-input', style: 'width:100%;margin-bottom:10px' }, [
        ...
        var det = h('textarea', { class: 'lr-input', rows: '3', placeholder: 'Additional details (optional)', style: 'width:100%;margin-bottom:10px' });
        var sub = h('button', {
          class: 'lr-btn-primary', style: 'width:100%', onclick: function () {
            if (!sel.value) return;
